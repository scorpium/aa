...
echo
	...
	git clone https://github.com/scorpium/alis $buildFolder/archiso/airootfs/alis
	mkdir $buildFolder/archiso/airootfs/alis-dev
	git clone https://github.com/scorpium/alis-dev $buildFolder/archiso/airootfs/alis-dev 
